...
// Only the standard look ships. The 8-Bit and Custom skins were removed from
// the product; because normalizeSkin() coerces any unregistered id back to the
// default, anyone whose browser still has "8bit" or "custom" stored lands on
// "normal" automatically — no migration needed.
