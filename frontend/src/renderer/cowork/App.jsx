...
function AppCore() {
  ...
  // Theme — dark only. The light theme was removed from the product, so this
  // is fixed rather than read from localStorage: a browser that still has
  // "light" stored would otherwise come back up in a theme the app no longer
  // ships. The animated background canvas (gravity-field) and the body's bg
  // colour both follow this value.
  ...
  return (
    <div style={{
      ...
      */}
      ...
      {/* The floating theme and skin toggles were removed along with the light
          theme and the 8-Bit/Custom skins — each had only one state left. */}
