          ...
          <div style={{ maxWidth: 820 }}>
            ...
            {settings.managedModels && (
              <div style={{
                ...
                <strong style={{ color: 'var(--text-strong)' }}>Models are managed by your administrator.</strong>
                {' '}AWS Bedrock credentials, routing, fallbacks, budgets, and usage records stay on the server.
                Current aliases: <code>{settings.planningModel}</code> for planning and <code>{settings.codingModel}</code> for coding.
              </div>
            )}
            ...
            <CollapsibleGroup title="Appearance">
              {/* Theme and Style pickers removed: the app ships dark-only with
                  the standard look, so both controls offered a single choice. */}
              {/* Custom-skin controls removed with the Custom skin itself. */}
