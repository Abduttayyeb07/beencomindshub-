...
if (typeof window !== 'undefined' && !(window as any).antontron) {
  ...
  // Apply the theme + skin on first paint (before React mounts) so the app
  // doesn't flash the wrong palette. Always dark: the light theme was
  // removed, so a stale saved "light" must not be honoured here.
