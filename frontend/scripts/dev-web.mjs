...
async function main() {
  ...
  // shell:true is required on Windows: npx resolves to npx.cmd, and since
  // Node 18.20/20.12 spawning a .cmd without a shell throws EINVAL (the
  // CVE-2024-27980 hardening). Harmless on POSIX.
  viteChild = spawn(
    'npx',
